...
function Enemy(xpos, ypos, t, s)
    ...
    local initialize = function ()
        ...
        elseif self.type == "basic" then return 150, 35, 50, Animation(i_squid_basic, 280, 280, 0.35, "basic"), Animation(i_squid_basic_flipped, 280, 280, 0.35, "basic")
        ...
        elseif self.type == "magala" then return 200, 100, 1000, Animation(i_magala, 560, 560, 0.5, "magala"), Animation(i_magala_flipped, 560, 560, 0.5, "magala")
